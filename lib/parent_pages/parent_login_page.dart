...
import 'package:test_app/widgets/login_state_provider.dart';
...
class ParentLoginPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      child: MouseRegion(
        cursor: loginState.isLoading
            ? SystemMouseCursors.basic
            : SystemMouseCursors
                .progress, // Change cursor based on loading state
        child: AbsorbPointer(
          absorbing:
              loginState.isLoading, // Prevent user interactions during loading
          child: Container(
            color: Colors
